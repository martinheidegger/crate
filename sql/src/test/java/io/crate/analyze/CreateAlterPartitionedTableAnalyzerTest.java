...
public class CreateAlterPartitionedTableAnalyzerTest extends CrateUnitTest {
    ...
    public void testPartitionedByMultipleColumns() throws Exception {
        CreateTableAnalyzedStatement analysis = (CreateTableAnalyzedStatement)e.analyze("create table my_table (" +
                                                                                        "  name string," +
                                                                                        "  date timestamp" +
    ...
    public void testAlterPartitionedTable() throws Exception {
        AlterTableAnalyzedStatement analysis = (AlterTableAnalyzedStatement)e.analyze(
