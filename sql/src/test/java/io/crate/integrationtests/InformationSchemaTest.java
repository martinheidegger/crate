...
public class InformationSchemaTest extends SQLTransportIntegrationTest {
    ...
    public void testColumnsColumns() throws Exception {
        ...
        assertThat(TestingHelpers.printedTable(response.rows()), is(
            ...
            "data_type| string| NULL| false| true| 2| columns| information_schema\n" +
            "generation_expression| string| NULL| false| true| 3| columns| information_schema\n" +
            "is_generated| boolean| NULL| false| true| 4| columns| information_schema\n" +
            "is_nullable| boolean| NULL| false| true| 5| columns| information_schema\n" +
            "ordinal_position| short| NULL| false| true| 6| columns| information_schema\n" +
